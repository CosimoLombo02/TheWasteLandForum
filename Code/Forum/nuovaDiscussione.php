...
<body>
    ...
    $flag=false;
     ...
     if(isset($_POST['Sottcategoria']))
     $sottocateg =$_POST['Sottcategoria'];
     else $sottocateg="";
     if(isset($_POST['categoriaSpoilerCustom']))
     $csc =$_POST['categoriaSpoilerCustom'];
     else $csc="";
...
<div class="containerP">
     ...
     <div class="colonnaGrandeC"><!--div1-->
        ...
        <input type="text" name ="Sottcategoria" value="<?php echo $sottocateg ?>" /></div>
     ...
     <div class="colonnaGrandeCR">
        ...
        if($flag){
        if($_POST['sottocategorie']=='altro') {
      
            echo "<script>attiva1();</script>";}
         // var_dump($_POST);
          if($_POST['sp']=='si') {
           
            echo "<script>attiva2();</script>"; }
            if($_POST['categorieSpoiler']=='altroS'){
                echo "<script>attiva3();</script>";
            }}
        ?>
